# Core Library Performance Analysis

Here is the performance profiling report for our core bioinformatics library. We measured execution runtimes across sequence lengths ranging from $10$ to $100,000$ characters. Below are the charts, observations on Python VM behavior, and recommendations for scaling the codebase.
...
*Log-log scale showing HammingDistance, ReverseComplement, Transcribe, and ValidateInput:*

![Linear Algorithms](linear_algorithms.png)

### 2. Quadratic-Time Algorithms (Linear Scale)
*Parabolic curves of LevenshteinDistance, NeedlemanWunsch, and SmithWaterman:*

![Quadratic Algorithms Linear](quadratic_algorithms_linear.png)

### 3. Quadratic-Time Algorithms (Log-Log Scale)
*Log-log scale showing the straight line with a slope $\approx 2$:*
...
### Why linear operations are so fast: Python VM translation magic
...
### Verifying quadratic complexity: Linear vs Log-Log plots
...
## Bottlenecks & Practical Limits

### 1. Pure Python Interpreter Loop Overhead
...
## Recommendations for Scaling the Codebase
